...
<template>
  <div class="card">
    <div class="photo-wrapper">
      <img :src="`/images/ressort/${club.numPhoto}.webp`" @error.once="$event.target.src=`https://apiclubmeds4a22-cqf0achtbje7d6ct.francecentral-01.azurewebsites.net/api/Clubs/photos/${club.numPhoto}.webp`" :alt="club.titre" class="club-img" loading="lazy" />
